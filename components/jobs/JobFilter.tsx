...
export interface TJobFilterRef {
...
const JobFilter = forwardRef<TJobFilterRef, Partial<IJobFilterProps>>(
  (props, ref) => {
    const {
      label,
      options = [],
    ...
    return (
      <div className="mb-3 w-full sm:w-auto">
        <MyPopOver
          ...
          className="translate-x-0 w-full  md:w-auto min-w-[12rem] py-4"
          showClose
          ref={popOverRef}
        >
          {options?.map((opt, i) => {
